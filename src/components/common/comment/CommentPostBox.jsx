    ...
    return (
        <div className="bg-white rounded-lg border p-2 mx-auto">
            <div className="px-3 mb-2 mt-2">
                <textarea placeholder="Post your comment here ..." className="w-full bg-gray-100 rounded border border-gray-400 leading-normal resize-none h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"></textarea>
            </div>
