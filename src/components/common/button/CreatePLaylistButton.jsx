    ...
    return (
        <>
            <button
                ...
                className={'bg-gray-300 text-black rounded-full text-md p-2 ml-2 mt-3 font-bold  hover:bg-white hover:text-black hover:border border-black'}>
                <IoMdAdd size={28} />
            </button>
            <Popup nested={props.nested} contentStyle={{width: '20%'}} open={open} closeOnDocumentClick
                   onClose={closeModal}>
