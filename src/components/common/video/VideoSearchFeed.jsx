...
export const VideoSearchFeed = (props) => {
    ...
    return (
        <div key={props.index * 2}
            ...
            <div className='col col-span-10 ml-8 flex flex-col justify-start'>
                ...
                <p className='traking-wider font-normal text-[10px] sm:text-[#0f0f0f] text-[13px] leading-[16px] break-words line-clamp-2 mt-[auto]'>{video.description}</p>
            </div>
        </div>
    )
}