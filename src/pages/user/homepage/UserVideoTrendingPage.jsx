...
export const UserVideoTrendingPage = (props) => {
    ...
    const fetchVideoData = async (page, pageSize) => {
        const result = await videoService.getTrendingVideoList(token, {
            page: page,
            pageSize: pageSize
        })
    ...
    const initVideoData = async () => {
        ...
        if (result.success) {
            ...
            if (result.data.count < videoPerRequest) {
                ...
                const resultMore = await videoService.getTrendingVideoList(token, {
                    page: 2,
                    pageSize: videoPerRequest
                })
